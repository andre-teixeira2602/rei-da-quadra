-- FIX: Corrigir assinatura das RPCs
-- Execute esta parte para corrigir os erros

-- Deletar funções antigas com assinatura incorreta
...
-- Deletar funções novas com assinatura correta (se existirem)
